...
const logoUrl = computed(() => {
  return theme.dark ? '/fix-kraft-logo-blue-bg.svg' : '/fix-kraft-logo-white-bg.svg'
})
...
<template>
  <nav class="sticky top-0 w-full bg-white/80 dark:bg-secondary backdrop-blur-md border-b border-gray-200 dark:border-gray-700 z-50">
